...
import 'package:flutter_feather_icons/flutter_feather_icons.dart' as Feather; 
      ...
      body: Container(
        ...
        child: SafeArea(
          child: SingleChildScrollView(
            // Removendo padding horizontal para que o conteúdo interno possa gerenciar a margem lateral
            ...
            child: Column(
              ...
              children: [
                // VOLTAR (CORRIGIDO)
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15), // Adiciona margem lateral
                  child: Row(
                        ...
                        if (actionType == "Desligar")
                          Column(
                            children: [
                              ...
                              // Espaçamento reduzido antes do botão Agendar Rotina
                              const SizedBox(height: 15), 
                            ],
                          ),
                ...
                const SizedBox(height: 15),
                // Cards individuais de regras
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15), // Adiciona margem lateral
                  child: Column(
                    children: [
                      RuleDetailCard(
                        icon: Feather.FeatherIcons.target,
                      ...
                      RuleDetailCard(
                        icon: Feather.FeatherIcons.clock,
                ...
                // VISÃO GERAL (STATUS DAS REGRAS ATIVAS) - CORRIGIDO FINALMENTE
                const SizedBox(height: 15),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15), // Adiciona margem lateral, ALINHANDO
                  child: _CardContainer(
                    cardBackground: cardBackground,
                    // O _CardContainer já aplica 15px de padding interno. 
                    // Removendo qualquer Padding duplicado aqui.
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text(
...
class _CardContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      // O CardContainer já aplica padding: 15.
